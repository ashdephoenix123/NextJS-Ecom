                ...
                <section className="text-gray-600 ">
                    <div className="container px-5 py-24 mx-auto">
                        ...
                        <div className="lg:w-2/3 md:w-2/3 mx-auto">
                            ...
                            <div className="flex flex-wrap -m-2">
                                <div className="p-2 md:py-6 w-1/2">
                                    <div className="">
                                        <label for="name" className="leading-7 text-md text-gray-600">Name</label>
                                ...
                                <div className="p-2 md:py-6 w-1/2">
                                    <div className="">
                                        <label for="email" className="leading-7 text-md text-gray-600">Email</label>
                                ...
                                <div className="p-2 md:py-6 w-full">
                                    <div className="">
                                        <label for="message" className="leading-7 text-md text-gray-600">Address</label>
                                ...
                                <div className="p-2 md:py-6 w-1/2">
                                    <div className="">
                                        <label for="phone" className="leading-7 text-md text-gray-600">Phone</label>
                                ...
                                <div className="p-2 md:py-6 w-1/2">
                                    <div className="">
                                        <label for="pincode" className="leading-7 text-md text-gray-600">Pincode (India)</label>
                                ...
                                <div className="p-2 md:py-6 w-1/2">
                                    <div className="">
                                        <label for="state" className="leading-7 text-md text-gray-600">State</label>
                                        <input type="number" id="phone" name="phone" className="w-full text-2xl mt-1 bg-opacity-50 rounded border border-gray-300 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-200 outline-none text-gray-700 py-3 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                    </div>
                                </div>
                                <div className="p-2 md:py-6 w-1/2">
                                    <div className="">
                                        <label for="district" className="leading-7 text-md text-gray-600">District</label>
                        ...
                        <div className="lg:w-2/3 md:w-2/3 mx-auto">
                                ...
                                <div className="w-full text-2xl bg-opacity-50 rounded border border-gray-300  outline-none bg-green-400 text-gray-700 py-8 px-6 leading-8 transition-colors duration-200 ease-in-out">
                                    <ol className=''>
                                        ...
                                        {Object.keys(cart).map((item, index) => {
                                            return <li key={item} className='flex justify-between'>
                                                {index + 1 + '. ' + cart[item].name}
                                                <div className='flex'>
                                                    <HiMinusCircle className='mr-1 cursor-pointer' onClick={() => { updateCartItem(item, cart[item].quantity, cart[item].price, cart[item].name, cart[item].size, cart[item].variant) }} size={20} />
                                                    <span>{cart[item].quantity}</span>
                                                    <HiPlusCircle className='ml-1 cursor-pointer' onClick={() => { addToCart(item, cart[item].quantity, cart[item].price, cart[item].name, cart[item].size, cart[item].variant) }} size={20} />
                                                    <MdDelete className='ml-1 cursor-pointer' onClick={() => { removeItem(item) }} size={20} />
                                                </div>
                                            </li>
                                        }
                                        )}
                            ...
                            <button className='mt-6 px-6 py-4 text-white bg-green-500 rounded hover:bg-green-600'>Pay ₹499 </button>
                            </div>
                        </div>
